...
Pilot is a zero-build, installable **Progressive Web App** (vanilla JS, ES modules — no framework, no bundler) that reframes a complete beginner's Raspberry Pi 5 book as a **36-lesson learning path**. It is designed for a total beginner: warm, plain-English, and impossible to get lost in.

### Highlights

- 🛤️ **The Learning Path** — a winding, Duolingo-style trail of all 36 lessons across 7 parts, with persisted progress, completion rings, copper circuit-trace connectors, and a "you are here" marker.
